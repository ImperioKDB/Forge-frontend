 ...
 *
 * Same split layout as login. Left panel uses GraphFragment variant="trace"
 * (more energetic than "settled" - fitting for first contact with the product).
 */
...
function LeftPanel() {
  return (
    ...
    >
      ...
      {/* GraphFragment: trace variant - shows the core value prop in motion */}
      ...
      <div className="relative z-10 flex flex-col gap-5">
        ...
        >
          Connect a repo, describe what you want to build, and let Forge plan,
          code, and ship it - with your approval at every step.
        </p>
    ...
    <div className="w-full max-w-sm flex flex-col gap-8">
      ...
      <form onSubmit={handleSignup} className="flex flex-col gap-4">
        ...
        <p className="font-body text-xs leading-relaxed" style={{ color: 'var(--ink-faint)' }}>
          ...
          and{' '}
          <span style={{ color: 'var(--ink-soft)' }}>Privacy Policy</span>.
        </p>
